...
#         self.async_example_persistence_adapter = AsyncExamplePersistenceAdapter(
#             async_db
#         )
...
#         )
#         related_async_example_schema = (
#             await AsyncExampleSteps.RelatedAsyncExample_스키마_생성(
...
#         # when
#         related_async_example_schema = (
#             await self.async_example_persistence_adapter.create_async_example_related(
#                 async_example=async_example_schema,
#                 related_async_example=related_async_example_schema,
#             )
#         )

#         # then
#         expected_related_async_example = (
#             await self.async_example_persistence_adapter.get_related_async_example(
#                 related_async_example_id=related_async_example_schema.id
#             )
#         )
#         expected_async_example_list: ASyncExampleSchemaList = (
#             await self.async_example_persistence_adapter.get_async_example_list(
...
#         assert (
#             expected_async_example_list.example_list[0].name
#             == async_example_schema.name
#         )
#         assert related_async_example_schema.name == expected_related_async_example.name
#         assert (
#             related_async_example_schema.description
#             == expected_related_async_example.description
#         )
...
#         print("expected_async_example_list: ", expected_async_example_list)
...
#         expected_related_async_example_list = (
#             await self.async_example_persistence_adapter.get_related_async_example_list(
